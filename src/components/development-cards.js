            ...
            <Container>
                ...
                <SuccessStories>
                    ...
                    {success.storiesCase.map((el, index) => (
                        <Link onClick={() => { datalayerPush(analytics.caseStudies(el.caseTitle ? el.caseTitle : el.previewImage.altText, index, location, el.button.url)) }} to={el.button.url} className="flex">
